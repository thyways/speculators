#!/usr/bin/env bash
# Online DFlash2 Training Script (Qwen3.6-35B-A3B + perfectblend, full attention)
...
OUTPUT_DIR="${OUTPUT_DIR:-${RUN_DIR:-$WS/model_weights/dflash2_qwen3_6-35b-a3b-perfectblend_2node}}"
...
RUN_NAME="${RUN_NAME:-dflash2-${COMMENT:-base}-fullattn-2node-${JOB_TAG}}"
SAVE_DIR="${CHECKPOINT_DIR:-$OUTPUT_DIR/runs/$RUN_NAME}"
LOG_DIR="${LOG_DIR:-$REPO/logs/train/qwen3_6_35b_a3b/dflash2_2node/$RUN_NAME}"
