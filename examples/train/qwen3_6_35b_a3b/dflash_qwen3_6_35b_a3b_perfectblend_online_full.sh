#!/usr/bin/env bash
# Full-data online DFlash training for Qwen3.6-35B-A3B on one 8-GPU node.
# Uses the official Qwen3.6-35B-A3B-DFlash target-feature and six-layer draft
# layout, canonical bidirectional DFlash blocks, and the paper's AdamW + cosine
# learning-rate recipe (4% linear warmup followed by cosine decay).
...
RUN_DIR="$REPO/output/dflash_qwen3_6_35b_a3b_perfectblend_online_500k"
...
HIDDEN_STATES_DIR="${TMPDIR:-/tmp}/dflash_qwen3_6_35b_a3b_${JOB_TAG}_hidden_states"
