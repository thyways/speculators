#!/usr/bin/env bash
# Online DSpark Training Script (Qwen3.6-35B-A3B + open-perfectblend, full dataset)
...
OUTPUT_DIR="$WS/model_weights/dspark_qwen3_6-35b-a3b-perfectblend"
...
HS_PATH="/tmp/hs_dspark_qwen3_6_35b_a3b_${JOB_TAG}"
...
RUN_NAME="dspark-${COMMENT:-base}-$(date +%Y%m%d-%H%M%S)"
