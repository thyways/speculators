#!/usr/bin/env bash
# Online Eagle3 Training Script (Qwen3.6-35B-A3B + open-perfectblend, full dataset)
...
OUTPUT_DIR="$WS/model_weights/eagle3_qwen3_6-35b-a3b-perfectblend"
...
HS_PATH="/tmp/hs_eagle3_qwen3_6_35b_a3b_${JOB_TAG}"
...
RUN_NAME="eagle3-${COMMENT:-base}-$(date +%Y%m%d-%H%M%S)"
SAVE_DIR="$OUTPUT_DIR/runs/$RUN_NAME"
echo "=== Step 4: Training Eagle3 ==="
