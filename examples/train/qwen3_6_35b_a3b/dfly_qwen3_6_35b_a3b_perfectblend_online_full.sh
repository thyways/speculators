#!/usr/bin/env bash
# Online DFly Training Script (Qwen3.6-35B-A3B + open-perfectblend, full dataset)
...
OUTPUT_DIR="$WS/model_weights/dfly_qwen3_6-35b-a3b-perfectblend"
...
HS_PATH="/tmp/hs_dfly_qwen3_6_35b_a3b_${JOB_TAG}"
...
RUN_NAME="dfly-${COMMENT:-base}-$(date +%Y%m%d-%H%M%S)"
