...
MODEL="$WORKSPACE/model_weights/dspark_qwen3_6_35b_a3b_perfectblend_online_500k/checkpoints/0"
...
OUTPUT_DIR="${OUTPUT_DIR:-$WORKSPACE/evaluation_results/dspark_qwen3_6_35b_a3b_ckpt0_${TIMESTAMP}}"
