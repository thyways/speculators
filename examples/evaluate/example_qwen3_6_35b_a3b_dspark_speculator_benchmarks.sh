#!/usr/bin/env bash
# Evaluate the local Qwen3.6-35B-A3B DSpark checkpoint with
# RedHatAI/speculator_benchmarks. Throughput mode records both speculative
# acceptance metrics and latency/TTFT/ITL/throughput metrics.
#
# Example smoke test:
#
#   SUBSETS=HumanEval MAX_REQUESTS=4 \
#     bash examples/evaluate/example_qwen3_6_35b_a3b_dspark_speculator_benchmarks.sh
#
...
MODEL="${MODEL:-$WORKSPACE/model_weights/dspark_qwen3_6_35b_a3b_5full/checkpoints/0}"
...
OUTPUT_DIR="${OUTPUT_DIR:-$WORKSPACE/evaluation_results/dspark_qwen3_6_35b_a3b_ckpt0_spec${NUM_SPECULATIVE_TOKENS}_${TIMESTAMP}}"
