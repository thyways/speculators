...
SINGLE_GPU_SCRIPT="$REPO/examples/evaluate/example_qwen3_6_35b_a3b_domino_speculator_benchmarks.sh"
...
OUTPUT_ROOT="${OUTPUT_ROOT:-$WORKSPACE/evaluation_results/domino_qwen3_6_35b_a3b_ckpt0_8gpu_${TIMESTAMP}}"
