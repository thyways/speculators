...
# warns. DFly, DSpark, Domino, and KV-native DFlash are DFlash-family models,
# so all of them read the dflash group; their exclusive settings remain in
# their own groups. eagle3 uses no algorithm group.
_ALGORITHM_GROUP_USERS: dict[str, frozenset[str]] = {
    ...
    "kv_native_dflash": frozenset({"kv_native_dflash"}),
